...
const activeContracts = [
    { id: 1, crop: 'Organic Wheat', buyer: 'Reliance Retail', price: '₹2,500/q', status: 'Active', progress: 2 },
    { id: 2, crop: 'Basmati Rice', buyer: 'ITC Limited', price: '₹4,200/q', status: 'Pending Delivery', progress: 4 },
];
        ...
        >
            ...
            <motion.div className="stats-grid" variants={containerVariants}>
                <Card className="stat-card">
                    <div className="stat-icon income"><IndianRupee size={24} /></div>
                ...
                <Card className="stat-card">
                    <div className="stat-icon contracts"><Package size={24} /></div>
                    <div className="stat-info">
                    ...
                    <div style={{ width: '100%', height: 300 }}>
                        <ResponsiveContainer width="100%" height="100%">
                            <AreaChart data={dummyData}>
                                ...
                                <Tooltip />
                                <Area type="monotone" dataKey="income" stroke="var(--primary)" fillOpacity={1} fill="url(#colorIncome)" strokeWidth={2} />
                            </AreaChart>
                        </ResponsiveContainer>
                    </div>
                </Card>
                ...
                <Card title="Recent Active Contracts" className="list-card">
                    <div className="contract-list">
                        {activeContracts.map(contract => (
                            <motion.div key={contract.id} className="contract-item" variants={itemVariants}>
                                ...
                                <div className="contract-status">
                                    ...
                                    <Badge status={contract.status === 'Active' ? 'success' : 'warning'}>
                                        {contract.status}
                                    </Badge>
                                </div>
                    ...
                    <Button variant="secondary" style={{ width: '100%', marginTop: '1rem' }}>View All Contracts</Button>
                </Card>
            </motion.div>

            <motion.div className="bottom-sections" variants={itemVariants}>
                <Card title="Current Contract Progress (Organic Wheat)" className="progress-card">
                    <Timeline
                        steps={['Draft', 'Negotiation', 'Accepted', 'Sowing', 'Growing', 'Harvesting', 'Delivery']}
                        currentStep={4}
                    />
                </Card>
            </motion.div>
